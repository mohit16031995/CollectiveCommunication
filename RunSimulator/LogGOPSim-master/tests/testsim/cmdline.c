...
const char *gengetopt_args_info_help[] = {
  ...
  "  -C, --LogGOPS_C=INT        P4: Time to transfer 1byte from the main memory to\n                               the NIC memory  (default=`1')",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->LogGOPS_C_help = gengetopt_args_info_help[18] ;
  args_info->LogGOPS_c_help = gengetopt_args_info_help[19] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hf:L:o:g:G:S:O:V:vbn:C:c:", long_options, &option_index);

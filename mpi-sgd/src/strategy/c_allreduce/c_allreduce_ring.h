 ...
 */
template<class IdxType, class ValType> int c_allreduce_ring(const ValType *values, struct stream *recvbuf, unsigned dim, MPI_Comm comm) {
  ...
  create_splitted_stream<IdxType, ValType>(values, splits, dim, p);

 ...
 * Sparse AllReduce
 */
template<class IdxType, class ValType> int c_allreduce_big(const ValType *values, struct stream *recvbuf, unsigned dim, MPI_Comm comm) {
  ...
  // Split streams
  create_splitted_stream<IdxType, ValType>(values, splits, dim, worldsize);
